    ...
    public async exec(msg: string, channel: Channel, brokerMsg: Message) {
        ...
        try {
            ...
            await this.entityManager.query(
                `INSERT INTO "verified_client_allowance" ("addressId", "verifierAddressId", "allowance", "height", "msgCID")
                 VALUES ${allowances.map(a => `('f0${a.clientId}', 'f0${a.verifierId}', ${a.allowance}, ${a.height}, '${a.msgCid}')`).join(', ')}
                `,
            );
